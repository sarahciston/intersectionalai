...
$( document ).ready( function() { 
    ...
    scalarapi.setBook( "https://scalar.usc.edu/works/intersectional-ai-toolkit" ); 
    ...
    function handleSuccess() {
        ...
        let node = scalarapi.getNode("https://scalar.usc.edu/works/intersectional-ai-toolkit/index");
        console.log(node)
